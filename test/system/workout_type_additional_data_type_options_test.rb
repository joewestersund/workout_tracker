...
class WorkoutTypeAdditionalDataTypeOptionsTest < ApplicationSystemTestCase
  setup do
    @workout_type_additional_data_type_option = workout_type_additional_data_type_options(:one)
  end

  test "visiting the index" do
    visit workout_type_additional_data_type_options_url
  ...
  test "creating a Workout type additional data type option" do
    ...
    fill_in "Name", with: @workout_type_additional_data_type_option.name
    fill_in "Order in list", with: @workout_type_additional_data_type_option.order_in_list
    fill_in "User", with: @workout_type_additional_data_type_option.user_id
    fill_in "Workout type additional data type", with: @workout_type_additional_data_type_option.workout_type_additional_data_type_id
