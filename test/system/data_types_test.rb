...
class WorkoutTypeDataTypesTest < ApplicationSystemTestCase
  ...
  test "visiting the index" do
    visit workout_type_data_types_url
  ...
  test "creating a Workout type additional data type" do
    ...
    fill_in "Data type name", with: @workout_type_data_type.data_type_name
    fill_in "Order in list", with: @workout_type_data_type.order_in_list
    fill_in "User", with: @workout_type_data_type.user_id
    fill_in "Workout type", with: @workout_type_data_type.workout_type_id
