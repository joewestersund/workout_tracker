...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference('User.count') do
      post users_url, params: { user: { email: @user.email, name: @user.name, password_digest: @user.password_digest, password_reset_sent_at: @user.password_reset_sent_at, remember_token: @user.remember_token, reset_password_token: @user.reset_password_token, time_zone: @user.time_zone } }
    end
