module UsersHelper
  ...
  def create_user_defaults(user)
    wt = user.workout_types.create!(name: "running", order_in_list: 1)
      ...
      dt = wt.data_types.create!(user: user, name: "hr", unit: "bpm", field_type: DataType.field_types_hash[:numeric], order_in_list: 2)
      ...
      dt = wt.data_types.create!(user: user, name: "notes", field_type: DataType.field_types_hash[:text], order_in_list: 4)
